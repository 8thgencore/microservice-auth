...
func (mmGenerateAccessToken *TokenOperationsMock) GenerateAccessToken(user model.User) (s1 string, err error) {
	...
	if mmGenerateAccessToken.GenerateAccessTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			mmGenerateAccessToken.t.Errorf("TokenOperationsMock.GenerateAccessToken got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TokenOperationsMock) MinimockGenerateAccessTokenInspect() {
	for _, e := range m.GenerateAccessTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TokenOperationsMock.GenerateAccessToken with params: %#v", *e.params)
		}
	}
	...
	if m.GenerateAccessTokenMock.defaultExpectation != nil && afterGenerateAccessTokenCounter < 1 {
		if m.GenerateAccessTokenMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to TokenOperationsMock.GenerateAccessToken")
		} else {
			m.t.Errorf("Expected call to TokenOperationsMock.GenerateAccessToken with params: %#v", *m.GenerateAccessTokenMock.defaultExpectation.params)
		}
	}
	...
	if !m.GenerateAccessTokenMock.invocationsDone() && afterGenerateAccessTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to TokenOperationsMock.GenerateAccessToken but found %d calls",
			mm_atomic.LoadUint64(&m.GenerateAccessTokenMock.expectedInvocations), afterGenerateAccessTokenCounter)
	}
}
...
func (mmGenerateRefreshToken *TokenOperationsMock) GenerateRefreshToken(userID string) (s1 string, err error) {
	...
	if mmGenerateRefreshToken.GenerateRefreshTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			mmGenerateRefreshToken.t.Errorf("TokenOperationsMock.GenerateRefreshToken got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TokenOperationsMock) MinimockGenerateRefreshTokenInspect() {
	for _, e := range m.GenerateRefreshTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TokenOperationsMock.GenerateRefreshToken with params: %#v", *e.params)
		}
	}
	...
	if m.GenerateRefreshTokenMock.defaultExpectation != nil && afterGenerateRefreshTokenCounter < 1 {
		if m.GenerateRefreshTokenMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to TokenOperationsMock.GenerateRefreshToken")
		} else {
			m.t.Errorf("Expected call to TokenOperationsMock.GenerateRefreshToken with params: %#v", *m.GenerateRefreshTokenMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GenerateRefreshTokenMock.invocationsDone() && afterGenerateRefreshTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to TokenOperationsMock.GenerateRefreshToken but found %d calls",
			mm_atomic.LoadUint64(&m.GenerateRefreshTokenMock.expectedInvocations), afterGenerateRefreshTokenCounter)
	}
}
...
func (mmVerifyAccessToken *TokenOperationsMock) VerifyAccessToken(tokenStr string) (up1 *model.UserClaims, err error) {
	...
	if mmVerifyAccessToken.VerifyAccessTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			mmVerifyAccessToken.t.Errorf("TokenOperationsMock.VerifyAccessToken got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TokenOperationsMock) MinimockVerifyAccessTokenInspect() {
	for _, e := range m.VerifyAccessTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TokenOperationsMock.VerifyAccessToken with params: %#v", *e.params)
		}
	}
	...
	if m.VerifyAccessTokenMock.defaultExpectation != nil && afterVerifyAccessTokenCounter < 1 {
		if m.VerifyAccessTokenMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to TokenOperationsMock.VerifyAccessToken")
		} else {
			m.t.Errorf("Expected call to TokenOperationsMock.VerifyAccessToken with params: %#v", *m.VerifyAccessTokenMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.VerifyAccessTokenMock.invocationsDone() && afterVerifyAccessTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to TokenOperationsMock.VerifyAccessToken but found %d calls",
			mm_atomic.LoadUint64(&m.VerifyAccessTokenMock.expectedInvocations), afterVerifyAccessTokenCounter)
	}
}
...
func (mmVerifyRefreshToken *TokenOperationsMock) VerifyRefreshToken(tokenStr string) (rp1 *model.RefreshClaims, err error) {
	...
	if mmVerifyRefreshToken.VerifyRefreshTokenMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			mmVerifyRefreshToken.t.Errorf("TokenOperationsMock.VerifyRefreshToken got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *TokenOperationsMock) MinimockVerifyRefreshTokenInspect() {
	for _, e := range m.VerifyRefreshTokenMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to TokenOperationsMock.VerifyRefreshToken with params: %#v", *e.params)
		}
	}
	...
	if m.VerifyRefreshTokenMock.defaultExpectation != nil && afterVerifyRefreshTokenCounter < 1 {
		if m.VerifyRefreshTokenMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to TokenOperationsMock.VerifyRefreshToken")
		} else {
			m.t.Errorf("Expected call to TokenOperationsMock.VerifyRefreshToken with params: %#v", *m.VerifyRefreshTokenMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.VerifyRefreshTokenMock.invocationsDone() && afterVerifyRefreshTokenCounter > 0 {
		m.t.Errorf("Expected %d calls to TokenOperationsMock.VerifyRefreshToken but found %d calls",
			mm_atomic.LoadUint64(&m.VerifyRefreshTokenMock.expectedInvocations), afterVerifyRefreshTokenCounter)
	}
}
