...
// AddRoleEndpoint implements repository.AccessRepository
	...
	if mmAddRoleEndpoint.AddRoleEndpointMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmAddRoleEndpoint.t.Errorf("AccessRepositoryMock.AddRoleEndpoint got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.endpoint != nil && !minimock.Equal(*mm_want_ptrs.endpoint, mm_got.endpoint) {
				mmAddRoleEndpoint.t.Errorf("AccessRepositoryMock.AddRoleEndpoint got unexpected parameter endpoint, want: %#v, got: %#v%s\n", *mm_want_ptrs.endpoint, mm_got.endpoint, minimock.Diff(*mm_want_ptrs.endpoint, mm_got.endpoint))
			}

			if mm_want_ptrs.allowedRoles != nil && !minimock.Equal(*mm_want_ptrs.allowedRoles, mm_got.allowedRoles) {
				mmAddRoleEndpoint.t.Errorf("AccessRepositoryMock.AddRoleEndpoint got unexpected parameter allowedRoles, want: %#v, got: %#v%s\n", *mm_want_ptrs.allowedRoles, mm_got.allowedRoles, minimock.Diff(*mm_want_ptrs.allowedRoles, mm_got.allowedRoles))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmAddRoleEndpoint.t.Errorf("AccessRepositoryMock.AddRoleEndpoint got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *AccessRepositoryMock) MinimockAddRoleEndpointInspect() {
	for _, e := range m.AddRoleEndpointMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AccessRepositoryMock.AddRoleEndpoint with params: %#v", *e.params)
		}
	}
	...
	if m.AddRoleEndpointMock.defaultExpectation != nil && afterAddRoleEndpointCounter < 1 {
		if m.AddRoleEndpointMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to AccessRepositoryMock.AddRoleEndpoint")
		} else {
			m.t.Errorf("Expected call to AccessRepositoryMock.AddRoleEndpoint with params: %#v", *m.AddRoleEndpointMock.defaultExpectation.params)
		}
	}
	...
	if !m.AddRoleEndpointMock.invocationsDone() && afterAddRoleEndpointCounter > 0 {
		m.t.Errorf("Expected %d calls to AccessRepositoryMock.AddRoleEndpoint but found %d calls",
...
// DeleteRoleEndpoint implements repository.AccessRepository
func (mmDeleteRoleEndpoint *AccessRepositoryMock) DeleteRoleEndpoint(ctx context.Context, endpoint string) (err error) {
	...
	if mmDeleteRoleEndpoint.DeleteRoleEndpointMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDeleteRoleEndpoint.t.Errorf("AccessRepositoryMock.DeleteRoleEndpoint got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.endpoint != nil && !minimock.Equal(*mm_want_ptrs.endpoint, mm_got.endpoint) {
				mmDeleteRoleEndpoint.t.Errorf("AccessRepositoryMock.DeleteRoleEndpoint got unexpected parameter endpoint, want: %#v, got: %#v%s\n", *mm_want_ptrs.endpoint, mm_got.endpoint, minimock.Diff(*mm_want_ptrs.endpoint, mm_got.endpoint))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteRoleEndpoint.t.Errorf("AccessRepositoryMock.DeleteRoleEndpoint got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *AccessRepositoryMock) MinimockDeleteRoleEndpointInspect() {
	for _, e := range m.DeleteRoleEndpointMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AccessRepositoryMock.DeleteRoleEndpoint with params: %#v", *e.params)
		}
	}
	...
	if m.DeleteRoleEndpointMock.defaultExpectation != nil && afterDeleteRoleEndpointCounter < 1 {
		if m.DeleteRoleEndpointMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to AccessRepositoryMock.DeleteRoleEndpoint")
		} else {
			m.t.Errorf("Expected call to AccessRepositoryMock.DeleteRoleEndpoint with params: %#v", *m.DeleteRoleEndpointMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.DeleteRoleEndpointMock.invocationsDone() && afterDeleteRoleEndpointCounter > 0 {
		m.t.Errorf("Expected %d calls to AccessRepositoryMock.DeleteRoleEndpoint but found %d calls",
...
// UpdateRoleEndpoint implements repository.AccessRepository
func (mmUpdateRoleEndpoint *AccessRepositoryMock) UpdateRoleEndpoint(ctx context.Context, endpoint string, allowedRoles []string) (err error) {
	...
	if mmUpdateRoleEndpoint.UpdateRoleEndpointMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUpdateRoleEndpoint.t.Errorf("AccessRepositoryMock.UpdateRoleEndpoint got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.endpoint != nil && !minimock.Equal(*mm_want_ptrs.endpoint, mm_got.endpoint) {
				mmUpdateRoleEndpoint.t.Errorf("AccessRepositoryMock.UpdateRoleEndpoint got unexpected parameter endpoint, want: %#v, got: %#v%s\n", *mm_want_ptrs.endpoint, mm_got.endpoint, minimock.Diff(*mm_want_ptrs.endpoint, mm_got.endpoint))
			}

			if mm_want_ptrs.allowedRoles != nil && !minimock.Equal(*mm_want_ptrs.allowedRoles, mm_got.allowedRoles) {
				mmUpdateRoleEndpoint.t.Errorf("AccessRepositoryMock.UpdateRoleEndpoint got unexpected parameter allowedRoles, want: %#v, got: %#v%s\n", *mm_want_ptrs.allowedRoles, mm_got.allowedRoles, minimock.Diff(*mm_want_ptrs.allowedRoles, mm_got.allowedRoles))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdateRoleEndpoint.t.Errorf("AccessRepositoryMock.UpdateRoleEndpoint got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *AccessRepositoryMock) MinimockUpdateRoleEndpointInspect() {
	for _, e := range m.UpdateRoleEndpointMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to AccessRepositoryMock.UpdateRoleEndpoint with params: %#v", *e.params)
		}
	}
	...
	if m.UpdateRoleEndpointMock.defaultExpectation != nil && afterUpdateRoleEndpointCounter < 1 {
		if m.UpdateRoleEndpointMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to AccessRepositoryMock.UpdateRoleEndpoint")
		} else {
			m.t.Errorf("Expected call to AccessRepositoryMock.UpdateRoleEndpoint with params: %#v", *m.UpdateRoleEndpointMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.UpdateRoleEndpointMock.invocationsDone() && afterUpdateRoleEndpointCounter > 0 {
		m.t.Errorf("Expected %d calls to AccessRepositoryMock.UpdateRoleEndpoint but found %d calls",
