...
//
// UserV1 defines the User service which provides methods to create, get, update, and delete users.
type UserV1Client interface {
	...
	// UpdateMe allows the currently authenticated user to update their own
	// information
